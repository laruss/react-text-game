            ...
            hotspots.push(
                h.image(
                    ...
                    },
                    {
                        ...
                        tooltip: {
                            content:
                                "Castle Valdoria - you need permission to enter",
                            position: "bottom",
                        },
                        zoom: "40%",
                    }
        ...
        if (environment.discoveredLocations.dragonLair) {
            hotspots.push(
                h.image(
                    ...
                    },
                    {
                        ...
                        tooltip: {
                            content:
                                "Mount Doom - lair of Vexarion the Terrible",
                            position: "left",
                        },
                        zoom: "20%",
                    }
            ...
            hotspots.push(
                h.label("???", {
                    ...
                    tooltip: {
                        content:
                            "A dark mountain shrouded in smoke and mystery",
                        position: "left",
                    },
                    variant: "ghost",
                    color: "danger",
        ...
        hotspots.push(
            h.menu(
                ...
                ],
                {
                    position: { x: 52, y: 70 },
                    direction: "vertical",
                    className: "bg-card/90 rounded-lg p-1",
                }
            )
        );
